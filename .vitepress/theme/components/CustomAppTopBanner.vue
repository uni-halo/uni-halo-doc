...
const BANNER_STORAGE_KEY = 'uni-halo-doc-banner-dismissed-time';
const TWENTY_FOUR_HOURS = 2 * 60 * 60 * 1000; // 2小时的毫秒数
...
const currentBanner = ref<IBanner>({
	...
	action: '我要提交',
	link: 'https://github.com/uni-halo/uni-halo/issues/1'
});
